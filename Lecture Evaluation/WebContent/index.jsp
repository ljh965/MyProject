...
<body>
	...
	<section class="container">
		<form method="post" action="./index.jsp" class="form-inline mt-3">
		...
		<div class="card bg-light mt-3">
			<div class="card-header bg-light">
				<div class="row">
					<div class="col-8 text-left">컴퓨터개론&nbsp;<small>이재현</small></div>
			...
			<div class="card-body">
				<h5 class="card-title">
					정말 좋은 강의에요.&nbsp;<small>(2019년 가을학기)</small>
				</h5>
				<p class="card-text">강의가 많이 널널해서, 솔직히 많이 배운 건 없는 것 같지만 학점도 잘 나오고 너무 좋은것 같습니다.
				<div class="row">
					<div class="col-9 text-left">
						성적 <span style="color: red;">A</span>
						편함 <span style="color: red;">A</span>
