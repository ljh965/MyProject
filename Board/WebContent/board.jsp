			...
			<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
				...
				<tbody>
					...
					<tr>
						...
						<td><a href="view.jsp?bID=<%= list.get(i).getbID() %>"><%= list.get(i).getbTitle().replaceAll(" ", "&nbsp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replace("\n", "<br>") %></a></td>
						<td><%= list.get(i).getUserID() %></td>
						<td><%= list.get(i).getbDate().substring(2,11) + list.get(i).getbDate().substring(11,13) + ":" + list.get(i).getbDate().substring(14,16) %></td>
					</tr>
					<%
						}
					%>
